 ...
 * https://github.com/korhner/asciimg/blob/95c7764a6abe0e893fa
 * e56b3b6b580e09e1de209/src/main/java/io/korhner/asciimg/image/AsciiImgCache.java
 ...
 *
 * @author Dan Nirel and Rachel Behar
 */
public class CharConverter {
	/**
	 * Fractional X offset for glyph centering.
	 */
	private static final double X_OFFSET_FACTOR = 0.2;
	/**
	 * Fractional Y offset for glyph centering.
	 */
	private static final double Y_OFFSET_FACTOR = 0.75;
	/**
	 * Font used when rasterizing characters.
	 */
	private static final String FONT_NAME = "Courier New";
	/**
	 * Width/height in pixels of the rendered character mask.
	 */
	public static final int DEFAULT_PIXEL_RESOLUTION = 16;

	/**
	 * Render the given character into a square black-and-white mask.
	 *
	 * @param c ASCII character to render
	 * @return 2D boolean mask of size DEFAULT_PIXEL_RESOLUTION×DEFAULT_PIXEL_RESOLUTION,
	 * where true indicates a white pixel.
	 */
	...
	/**
	 * Helper: create a BufferedImage of the character at the given pixel size.
	 *
	 * @param c            character to draw
	 * @param fontName     font family name
	 * @param pixelsPerRow desired image width/height
	 * @return ARGB BufferedImage containing the rendered glyph
	 */
